...
ActiveRecord::Schema.define(version: 20141117152350) do
  ...
  create_table "areas_oestrategicos", id: false, force: true do |t|
    t.integer "area_id"
    t.integer "oestrategico_id"
  end

  add_index "areas_oestrategicos", ["area_id", "oestrategico_id"], name: "index_areas_oestrategicos_on_area_id_and_oestrategico_id", using: :btree
